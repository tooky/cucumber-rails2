...
RSpec.describe Cucumber::Generators::InstallGenerator, :type => :generator do
  ...
  let(:rails_support) { content_for("feature/support/rails.rb") }

  it "generates features/support/rails.rb" do
    generator_command_notice = / This file was generated by the `rails generate cucumber:install` command./m
    run_generator
