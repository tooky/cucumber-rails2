...
namespace :generate do
  ...
  task :app do
    ...
    sh "bundle exec rails new #{app_dir} --skip-javascript --skip-sprockets --skip-git --skip-test-unit --skip-bundle --template=test_support/app_templates/hello_world.rb"
